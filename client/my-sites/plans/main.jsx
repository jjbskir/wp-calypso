...
var analytics = require( 'analytics' ),
	...
	createSitePlansObject = require( 'state/site-plans/assembler' ).createSitePlansObject;
...
module.exports = React.createClass( {
	...
	render: function() {
		...
		if ( this.props.siteSpecificPlansDetailsList.hasLoadedFromServer( selectedSiteDomain ) ) {
			currentPlan = createSitePlansObject( this.props.siteSpecificPlansDetailsList.getCurrentPlan( selectedSiteDomain ) );
