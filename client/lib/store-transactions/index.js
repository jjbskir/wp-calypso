...
function createPaygateToken( paygateRequestType, cardDetails, callback ) {
	wpcom.paygateConfiguration( { paygate_request_type: paygateRequestType }, function ( error, configuration ) {
		if ( error ) {
			callback( error );
			return;
		}
